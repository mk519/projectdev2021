function onLoadExam() {
    ...
    HttpGetPageLoadRequest("https://collegem820210207221016.azurewebsites.net/api/Exam/User/" + user.userId)
}
    ...
    fetch(url, {
        ...
        .then(dataJson => {
            ...
            for (e = 0; e < exams.length; e++) {
                ...
                document.getElementById("examList").innerHTML += exam.createChartHTML(getCourseCode(exam.classId, userData));
            }
        })
        .catch(err => {
